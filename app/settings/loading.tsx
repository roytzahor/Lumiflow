                ...
                <main className="px-5 py-2 space-y-6">
                    ...
                    <div className="rounded-3xl shadow-card bg-ios-card dark:bg-ios-dark-card overflow-hidden">
                        <div className="flex items-center gap-2.5 px-5 pt-5 pb-3">
                            <div className="w-8 h-8 rounded-lg bg-ios-gray-5 dark:bg-ios-dark-fill shrink-0" />
                            <div className="h-5 flex-1 bg-ios-gray-5 dark:bg-ios-dark-fill rounded-lg" />
                            <div className="w-5 h-5 rounded bg-ios-gray-6 dark:bg-ios-dark-fill shrink-0" />
                        </div>
                            ...
                            <div className="rounded-xl bg-ios-gray-6 dark:bg-ios-dark-fill h-36 w-full divide-y divide-gray-200/50 dark:divide-white/10 overflow-hidden p-0">
                                {[1, 2, 3, 4].map((row) => (
                                    <div key={row} className="flex items-center justify-between px-4 py-3 border-b border-gray-200/40 dark:border-white/10 last:border-0">
                                        <div className="h-4 w-28 bg-ios-gray-5/90 dark:bg-ios-dark-fill rounded" />
                                        <div className="flex gap-1">
                                            <div className="w-7 h-7 rounded bg-ios-gray-5/80 dark:bg-ios-dark-fill" />
                                            <div className="w-7 h-7 rounded bg-ios-gray-5/80 dark:bg-ios-dark-fill" />
                                        </div>
                                    </div>
                                ))}
                    ...
                    <div className="h-12 w-full rounded-xl bg-ios-text dark:bg-white opacity-90" />

                    <section className="pt-2 pb-4">
                        <div className="h-3 w-24 bg-ios-gray-5 dark:bg-ios-dark-fill rounded mx-auto" />
                    </section>
                </main>
            </div>
        </div>
